...
--
-- Host: localhost
-- Generation Time: Apr 07, 2011 at 12:21 AM
...
CREATE TABLE IF NOT EXISTS `WEAPONS_FIREARMS` (
  ...
  KEY `weaponNameId` (`weapon_name`,`firearm_id`)
...
CREATE TABLE IF NOT EXISTS `supply_list` (
  ...
  `usage` varchar(240) DEFAULT NULL,
  PRIMARY KEY (`item_id`),
  KEY `supplyNameId` (`item_name`,`item_id`)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `user_id` (`user_id`),
  KEY `user_name_index` (`username`),
  KEY `user_indentification` (`user_id`)
...
(6, 'jimbo', '3b7273a9a64c0ff267e7f55505726b22fac7fbf2'),
(7, 'sally', '1b2b618ca651cc7aead8bd05cca4122c5fd03712'),
(8, 'joe', 'c16fbe5548b1cf4aaed8fdee5b5faecd546fbd48');
...
INSERT INTO `weapon_firearm_preferences` (`weapon_firearm_preference_id`, `user_id`, `firearm_id`) VALUES
(6, 8, 5),
(7, 8, 4),
(8, 7, 3),
(9, 7, 1);
...
INSERT INTO `weapon_preferences` (`weapon_preference_id`, `user_id`, `weapon_id`) VALUES
(7, 8, 10),
(8, 8, 9),
(9, 7, 10),
(10, 7, 8),
...
CREATE TABLE IF NOT EXISTS `weapons_general` (
  ...
  KEY `weaponNameId` (`weapon_name`,`weapon_id`)
...
INSERT INTO `z_film_preferences` (`film_preference_id`, `film_id`, `user_id`) VALUES
(1, 3, 7);
...
(6, 'potato farmer', 'R', 80, 1995, 'those potatoes are damn zombies!					'),
(7, 'cabbage grower', 'R', 90, 1996, 'Look out for dem zombie cabbages');
...
CREATE TABLE IF NOT EXISTS `z_games` (
  ...
  `reasoning` varchar(240) DEFAULT NULL,
  PRIMARY KEY (`game_id`),
  KEY `gameTitleAndId` (`title`,`game_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `z_sites` (
  ...
  KEY `siteNameId` (`site_name`,`website_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;
